...
inline pros::MotorGroup left_motor_group({-10, 9, -17}, pros::MotorGearset::blue); // left motors on ports 1, 2, 3
inline pros::MotorGroup right_motor_group({20, -19, 18}, pros::MotorGearset::blue); // right motors on ports 4, 5, 6
...
inline lemlib::ControllerSettings angular_controller(1.98, // proportional gain (kP)
